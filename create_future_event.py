#!/usr/bin/env python
"""Gelecek tarihli test etkinliği ve bildirimleri oluştur"""
import os
import django
...
# Gelecek tarihli etkinlik oluştur (1 saat sonra)
future_datetime = timezone.now() + timedelta(hours=1)
